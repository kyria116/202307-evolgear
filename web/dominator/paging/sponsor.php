...
<body data-color="grey" class="flat">
	<div id="wrapper">
		...
		$db_name = "sponsor";
		$id_name = "s_id";
		$title_name_tw = "s_title_tw";
		$title_name_en = "s_title_en";
		$stitle_name = "s_stitle";
		$ctext_name = "s_ctext";
		$mtext_name = "s_mtext";
		$order_name = "s_order";
									...
									?>
											<tr>
												<td style="text-align: center; vertical-align: middle;" width="15%" id="td_img">
													<div class="btn-group">
														<button class="btn btn-xs btn-info" style="margin-right:10px" onclick=" javascript:location.href='image.php?page_id=4&id=<?php echo $v[$id_name]; ?>' ;">圖片管理</button>
