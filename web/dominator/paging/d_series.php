...
$sql = "SELECT dm_title,dm_id FROM d_mclass WHERE dm_id = :id";
									...
									?>
											<tr>
												<td style="text-align: center; vertical-align: middle;" width="20%" id="td_img">
													<div class="btn-group">
														<button style="margin-right: 10px;" class="btn btn-xs btn-info" onclick="javascript:location.href='download.php?id=<?php echo $v[$id_name]; ?>'">單元型錄</button>
