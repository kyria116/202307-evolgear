									...
									<?php if ($id > 10) { ?>
										<div class='form-group <?php echo $status_name; ?>'>
											...
											<div class='col-sm-9 col-md-9 col-lg-10'>
												...
												<button data-toggle="dropdown" class="btn btn-xs btn-info dropdown-toggle" style="margin-right:5px;" onclick="window.open('<?php echo $url_set . $_SERVER['HTTP_HOST'] . '/article.php?id=' . $data[$id_name]; ?>')">查看 </button>
											</div>
										</div>
									<?php } ?>
